...
Velocity.prototype.pruneQueue = function() {
  ...
  while(this.timeQueue.length && this.timeQueue[0] < (Date.now() - 100)) {
...
Velocity.prototype.lastPosition = function() {
	return this.positionQueue[this.positionQueue.length - 1]
}

Velocity.prototype.lastTime = function() {
  return this.timeQueue[this.timeQueue.length - 1]
}

Velocity.prototype.getVelocity = function(position) {
